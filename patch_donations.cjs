...
// Footer Cell
const oldFooterCell = '{isAdmin && <td className="py-4 px-3 hidden md:table-cell"></td>}';
const newFooterCell = '{isAdmin && <td className="py-4 px-3"></td>}';
code = code.replace(oldFooterCell, newFooterCell);

fs.writeFileSync('src/components/tabs/DonationsTab.tsx', code, 'utf8');
console.log('Patched contact info in DonationsTab table');
