const fs = require('fs');
let content = fs.readFileSync('src/components/tabs/MembersTab.tsx', 'utf8');
...
fs.writeFileSync('src/components/tabs/MembersTab.tsx', content, 'utf8');
console.log('Fixed MembersTab');
